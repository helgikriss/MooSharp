...
namespace MooSharpTests.Services
{
	...
	{
		private MilestonesService _service;
		[TestInitialize]
		public void Initialize() {
			...
			_service = new MilestonesService(fakeDb);
		}
		...
		public void TestGetAllMileStonesByAssignmentId() {
			...
			// Act
			var result = _service.GetAllMilestonesByAssignmentId(assignmentID);

			// Assert
			Assert.AreEqual(2, result.Count);
			Assert.AreEqual("Milestone 1", result[0].Title);
		}
	}
}
